...
<div class="row my-3">
  <div class="col-lg">
    <div class="text-center text-lg-start">
      ...
      <?php if ($query['sisa_pinjaman'] >= 0.1) : ?>
        ...
        <tbody>
          ...
          <?php foreach ($dataTransaksi as $data) : ?>
            <tr>
              ...
              <td><?= $data['sisa_pinjaman'] == 0 || $data['sisa_pinjaman'] <= 0.1 ? "<small class='badge rounded-pill text-bg-success'><i class='fas fa-check-circle'></i> LUNAS</small>" : "Rp. " . number_format($data['sisa_pinjaman'], 0, '.', '.') ?></td>
