...
if (isset($_POST['update'])) {
  ...
  if ($nama == null || $alamat == null || $no_telp == null || $da_motor == null || $dicairkan_oleh == null || $no_kontrak == null || $jenis_pencairan == null) {
    $invalid = "is-invalid";
  } else {
    $query = mysqli_query($koneksi, "UPDATE tb_peminjam SET nama='$nama', alamat='$alamat', no_telp='$no_telp', da_motor='$da_motor', dicairkan_oleh='$dicairkan_oleh', no_kontrak='$no_kontrak', jenis_pencairan='$jenis_pencairan' WHERE id = '$id'");
    if ($query) {
      echo "
      <script>
    ...
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <div class="mb-3">
          ...
          <?php if ($invalid) : ?>
            <div class="invalid-feedback">
              Dicairkan Oleh tidak boleh kosong.
            </div>
          <?php endif; ?>
        </div>
      </div>
